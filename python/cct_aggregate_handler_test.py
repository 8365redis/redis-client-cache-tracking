...
def test_basic_ft_aggregate_handler_basic():
    ...
    TEST_APP_NAME_1 = "test_basic_ft_aggregate_handler_basic"
    QUERY_TTL = 1
...
def test_basic_ft_aggregate_handler_multi_request_single_client():
    ...
    TEST_APP_NAME_1 = "test_basic_ft_aggregate_handler_multi_request_single_client"
    QUERY_TTL = 1
...
def test_basic_ft_aggregate_handler_single_request_multi_client():
    ...
    TEST_APP_NAME_1 = "test_basic_ft_aggregate_handler_single_request_multi_client_1"
    TEST_APP_NAME_2 = "test_basic_ft_aggregate_handler_single_request_multi_client_2"
    TEST_APP_NAME_3 = "test_basic_ft_aggregate_handler_single_request_multi_client_3"
    QUERY_TTL = 2
    ...
    client2.execute_command("CCT2.HEARTBEAT")
    client3.execute_command("CCT2.HEARTBEAT")
    time.sleep(0.5)
    client1.execute_command("CCT2.HEARTBEAT")
    client2.execute_command("CCT2.HEARTBEAT")
    client3.execute_command("CCT2.HEARTBEAT")
